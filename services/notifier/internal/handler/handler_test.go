...
func TestHandle_Enriched(t *testing.T) {
	...
	snd := &fakeSender{}
	New(enr, nil, snd, "999", dd(), cd(), nil, nil, quiet()).Handle(context.Background(), trade)
...
func TestHandle_PositionExitAlert(t *testing.T) {
	...
	h := New(enr, nil, snd, "1", dd(), cd(), cache, nil, quiet())
...
func TestHandle_DeduplicatesRepeatTrade(t *testing.T) {
	enr := fakeEnricher{resp: &lobsterrollv1.EnrichTokenResponse{MarketQuestion: "Q", Outcome: "Yes"}}
	snd := &fakeSender{}
	h := New(enr, nil, snd, "1", dd(), cd(), nil, nil, quiet())
...
func TestHandle_NilCooldownDisablesCollapsing(t *testing.T) {
	enr := fakeEnricher{resp: &lobsterrollv1.EnrichTokenResponse{MarketQuestion: "Q", Outcome: "Yes"}}
	snd := &fakeSender{}
	h := New(enr, nil, snd, "1", dd(), nil, nil, nil, quiet()) // cooldown disabled
...
func TestHandle_WithStats_RendersStatsLine(t *testing.T) {
	...
	snd := &fakeSender{}
	New(enr, st, snd, "1", dd(), cd(), nil, nil, quiet()).Handle(context.Background(), trade)
...
func TestHandle_EnrichmentNotFound_StillAlerts(t *testing.T) {
	...
	snd := &fakeSender{}
	New(enr, nil, snd, "1", dd(), cd(), nil, nil, quiet()).Handle(context.Background(), trade)
...
func TestHandleConsensus_Found(t *testing.T) {
	...
	New(enr, nil, snd, "777", dd(), cd(), nil, nil, quiet()).HandleConsensus(context.Background(), sig)
...
func TestHandleConsensus_EnrichmentNotFound_StillAlerts(t *testing.T) {
	...
	New(enr, nil, snd, "1", dd(), cd(), nil, nil, quiet()).HandleConsensus(context.Background(), sig)
...
func TestHandleConsensus_DeduplicatesSameCohort(t *testing.T) {
	enr := fakeEnricher{resp: &lobsterrollv1.EnrichTokenResponse{MarketQuestion: "Q", Outcome: "Yes"}}
	snd := &fakeSender{}
	h := New(enr, nil, snd, "1", dd(), cd(), nil, dd(), quiet())
